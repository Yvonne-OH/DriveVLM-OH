...
if __name__ == "__main__":
    ...
    # 添加新的用户对话和回答
    llava_conversation(llava_dialogue, "system", "Ststem Info.")
    llava_conversation(llava_dialogue, "user", "What about this image? How many birds do you see?", is_image=2)
