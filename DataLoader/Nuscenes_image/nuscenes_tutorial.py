...
nusc = NuScenes(version='v1.0-mini', dataroot='/media/oh/0E4A12890E4A1289/Nuimages-V1.0-mini', verbose=True)
...
"""### 3. `sample_data`
The nuScenes dataset contains data that is collected from a full sensor suite. 
We provide a `data` key to access these:
"""

print(my_sample['data'])

"""Let's take a look at the metadata of a `sample_data` taken from `CAM_FRONT`."""

sensor = 'CAM_FRONT'
cam_front_data = nusc.get('sample_data', my_sample['data'][sensor])
print("CAM_FRONT: ",cam_front_data)
